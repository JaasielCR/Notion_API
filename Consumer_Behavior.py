...
database_id = '276cff4d718c4a2f9d7c308569986227'
...
for page in pages_id:
    ...
    # page_name = response ['results'][i]['properties']['Title']['title'][0]['text']['content']
    print(f' \n The answer that Notion url sent is {page} this: {response}')
    print('')
    i = i + 1
...
new_page_data = {
    'parent': {
        'page_id': '4bc0f2a5f8564f0c9d0a824f4d6c6356'
    },
    'properties': {
        'title': {
            "type":"title",
            "title": [
                {
                    'text': {
                        'content': 'Summary of Callouts of 2 Unit'
                    }
                }
            ]
        }
